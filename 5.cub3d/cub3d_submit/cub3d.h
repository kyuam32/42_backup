...
/*   Updated: 2021/04/10 19:18:03 by namkyu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# include "1.libft/get_next_line.h"
...
void				alid_display(t_data *data);
int					alid_rgb(t_data *data, char *line, int *object, int bit);
void				alid_map(char *line, t_data *data);
void				alid_playerdir(t_data *data, char c, int row, int col);
